    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        <li class="active"><a href="/category"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Car Categories</span></a></li>
                        <li class=""><a href="/cars"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Cars</span></a></li>
                    </ul>
                </div>
            </div>
